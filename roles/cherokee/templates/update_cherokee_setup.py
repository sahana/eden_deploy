...
vserver!#!rule!500!document_root = /home/setup/applications/eden_setup/static
...
vserver!#!rule!400!document_root = /home/setup/applications/eden_setup/static/img
...
vserver!#!rule!400!match!directory = /eden_setup/static/img/
vserver!#!rule!400!match!final = 1
vserver!#!rule!300!document_root = /home/setup/applications/eden_setup/static
...
vserver!#!rule!300!match!directory = /eden_setup/static/
...
source!#!group = web2py
source!#!host = 127.0.0.1:59028
source!#!interpreter = /usr/local/bin/uwsgi -s 127.0.0.1:59028 --ini /home/setup/uwsgi.ini
source!#!nick = uWSGI #
source!#!timeout = 1000
source!#!type = host
source!#!user = web2py
...
try:
    ...
    vserver = vserver.replace("vserver!#", "vserver!40")
