...
vserver!#!rule!500!document_root = /home/test/applications/{{ appname }}/static
...
vserver!#!rule!400!document_root = /home/test/applications/{{ appname }}/static/img
...
vserver!#!rule!300!document_root = /home/test/applications/{{ appname }}/static
...
try:
    ...
    source = source.replace("source!#", "source!3")
    source = source.replace("uWSGI #", "uWSGI 3")
    vserver = vserver.replace("balancer!source!10 =", "balancer!source!10 = 3")
