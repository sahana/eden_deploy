...
vserver!#!rule!500!document_root = /home/demo/applications/{{ appname }}/static
...
vserver!#!rule!400!document_root = /home/demo/applications/{{ appname }}/static/img
...
vserver!#!rule!300!document_root = /home/demo/applications/{{ appname }}/static
...
source!#!interpreter = /usr/local/bin/uwsgi -s 127.0.0.1:59027 --ini /home/demo/uwsgi.ini
source!#!nick = uWSGI #
source!#!timeout = 1000
source!#!type = host
source!#!user = web2py
